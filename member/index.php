                            ...
                            <div class="row <?php echo $showMobile; ?>">
                                <div class="col-12 mb-2">
                                    <div class="alert alert-warning">
                                        ...
                                        Your are accessing your back office on a mobile device. Some features may not be available in mobile.
                                        For access to all features, please log into your back office on a laptop or desktop device.
                                    </div>
                                </div>
                            </div>
                            ...
                            <form method="post" action="verify.php" class="theme-form">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <div class="text-end mt-3">
                                        <button class="btn btn-primary btn-lg btn-block w-100" type="submit" name="memberLogin">
                                ...
                                <p class="mt-4 mb-0 text-center">
                                    Don't have account?<a class="ms-2" href="register">Create Account</a>
                                </p>
                            </form>
