 ...
 *
 * Responsibilities:
 * - Render the "Create New Password" form used in the password reset flow
 * - Accepts reset token + user id via query string and passes them through hidden inputs
 *
 * Notes:
 * - Validation of the reset token and user id should occur in resetPassword.php
 */
...
/**
 * Auth gate: logged-in users should not use the reset flow.
 */
...
/**
 * Pull reset params from query string for passthrough to the handler.
 * Keep them as strings and escape at output time.
 */
$code = isset($_GET['code']) ? (string)$_GET['code'] : '';
$userId = isset($_GET['user']) ? (string)$_GET['user'] : '';
            ...
            <div class="row justify-content-center">
                <div class="col-11 text-center my-3">
                    <a class="logo" href="index.php">
                        <img class="img-fluid"
                             src="images/<?php echo e(SYSTEM_LOGO); ?>"
                             title="<?php echo e(SYSTEM_NAME); ?>"
                             alt="<?php echo e(SYSTEM_NAME); ?>">
                    </a>
                </div>
                    ...
                    <div class="login-main login-card card">
                        <div class="card-body">
                            ...
                            <form method="post" action="resetPassword.php" class="theme-form">
                                ...
                                <input type="hidden" name="user" value="<?php echo e($userId); ?>">
                                ...
                                <div class="form-group mb-0">
                                    <div class="text-end mt-3">
                                        <button class="btn btn-primary btn-lg btn-block w-100" type="submit" name="resetPassword">
                                ...
                                <p class="mt-4 mb-0 text-center">
                                    <a class="ms-2" href="index"><i class="fa fa-backward"></i> Back to Login</a>
                                </p>
                            </form>
